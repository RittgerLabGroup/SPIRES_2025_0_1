...
%{
    ...
    espEnvWOFilter = ESPEnv(modisData, scratchPath = scratchPath, ...
...
%}
    ...
    methods
        function obj = AncillaryOutput(espEnvWOFilter, varargin)
            ...
            %   espEnvWOFilter = ESPEnv(modisData, ...
        ...
        function rootSubdivisionTable = writeRootSubdivisions(obj, varargin)
            ...
            %}
                    ...
                    thisWaterYearDate = WaterYearDate(thisDate, ...
                        ...
                        WaterYearDate.yearMonthWindow, dateOfToday = dateOfToday);
    ...
    %}
        ...
        function subdivisionTable = writeSubdivisionLinks(obj)
            ...
            for rank0Idx = 1:size(rootSubdivisionTable, 1)
                ...
                thisEspEnv = ESPEnv(thisModisData, ...

...
%---------------------------------------------------------------------------------------
codePath1 = ['/projects/', getenv('USER'), '/dev/esp/tbx/ESPToolbox'];
codePath2 = ['/projects/', getenv('USER'), '/MATLAB/RasterProjection'];
codePath3 = ['/projects/', getenv('USER'), '/dev/esp/updates/Regions'];
...
if strcmp(regionName, 'USAlaska')
    ...
    elevationSourceFilenames = {'50N150E_20101117_gmted_med075.tif', ...
...
elseif strcmp(regionName, 'easternNorthAmerica')
    tileRegionNames = {'h10v05', 'h11v04', 'h11v05', 'h12v04', 'h12v05', ...
        ...
        'h14v03', 'h14v04', 'h12v03' 'h13v04'}; % We exclude 'h11v01', there might an issue on land flag... 2024-02-09

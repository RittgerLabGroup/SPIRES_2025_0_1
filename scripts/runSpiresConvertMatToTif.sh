#!/bin/bash
#
# script to run job array to convert spiInver .mat file into spiresdailytifsinu,
# for a given tile and year.
#
...
#SBATCH --array=292001-292036,293001-293036
    # regionId concatenated with cellIdx, with 36 cells per tile.
...
outputDataLabels=(spiresdailytifsinu spiresdailymetadatajson)
filterConfLabel=

classdef Subdivision < handle
    ...
    %   write_stats values (in conf of variables or conf of variables regions).
...
%}
    ...
    methods
        ...
        function calcDailyStats(obj, waterYearDate)
            ...
            varConf = innerjoin(varConf, espEnv.myConf.variable, ...
            ...
            for dateIdx = 1:length(dateRange)
                ...
                for varIdx = 1:size(varConf, 1)
                    varName = varConf.output_name{varIdx};
        ...
        function [dailyStatTable, dailyStatFilePath] = setDailyStatTableAndFilePath( ...
            ...
            % varConf: Table(id, output_name, landSubdivisionStatId). Configuration of

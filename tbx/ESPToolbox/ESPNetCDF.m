...
%}
    ...
    properties(Constant)
        ...
        defaultGlobalAttribute = struct(...
            ...
            'Sebastien J. P. Lenard, Jessica Calme'], ...
...
%}
        ...
        function obj = setGlobalAttributes(obj)
            ...
            obj.globalAttribute.citation = ...
                ['Rittger, K., Brodzik, M. J., Lenard, S. J. P., ', ...
                'Stillinger, E. H. Bair, E. H., J. Dozier, J., ', ...
                'Painter, T. H. 2023. ', ...
                ...
                'ftp://dtn.rc.colorado.edu/shares/snow-today, doi:TBD'];
        ...
        function obj = setVariable(obj, var, ...
            ...
            [nAtts, ~] = size(attribute);
            for i = 1:nAtts
                netcdf.putAtt(obj.ncid, varID, ...
                   attribute{i,1}, attribute{i,2});
            end
...
%}
        function generateNetCDFFromRegionAndMatFile(region, thisDate, ...
            ...
            fprintf('%s: Start generating .nc %s from .mat %s: %s\n', mfilename(), ...
            ...
            for varIdx = 1:size(availableVariables, 1)
                ...
                attribute = {...
                    'long_name', varConf.('netCDF_long_name'){1}; ...
                    'standard_name', varConf.('netCDF_standard_name'){1}; ...
            ...
            % that we want to carry along into the .nc file.
            data = load(matFilePath, 'files');
            attribute = struct(...
                'STC_file', data.files{1, 2});
            thisNetCDF.addGlobalAttributes(attribute);
